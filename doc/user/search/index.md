...
[Sourcegraph](/admin/install.md) provides fast, advanced code search across multiple repositories. With Sourcegraph's code search, you can:
...
This document is for code search users. To get code search, [install Sourcegraph](/admin/install.md).
...
Diff searches can be further narrowed down with filters such as author and time. See the [query syntax documentation](/user/search/queries.md#diff-and-commit-searches-only) for a comprehensive list of supported tokens.
...
Commit message searches can be further narrowed down with filters such as author and time. See our [query syntax documentation](/user/search/queries.md#diff-and-commit-searches-only) for a comprehensive list of supported tokens.
...
See the [saved searches documentation](/user/search/saved_searches.md) for instructions for setting up and configuring saved searches.
...
[Sourcegraph.com](https://sourcegraph.com/search) is a public instance of [Sourcegraph](/admin/install.md) that lets you search inside any open-source project on GitHub. For demo purposes, you'll be prompted to narrow your query if it would search across more than 50 repositories. To lift this limitation or to search your organization's internal code, [run your own Sourcegraph instance](/admin/install.md).
