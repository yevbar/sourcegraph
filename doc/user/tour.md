...
Sourcegraph is a code search and intelligence tool for developers. It lets you search and explore all of your organization's code on the web, with integrations into your existing tools. See the [Sourcegraph overview](/user.md) for more general information.
...
- [Install the integration for your code host/review tool](/integration.md)
...
- [Install Sourcegraph](/admin/install.md) and add repositories
- [Install the browser extension and editor plugin](/integration.md) for a faster way to initiate searches (optional)
...
1.  Find and click on a search result that refers to the function you're looking for. (If needed, narrow your search using the suggested search filters below the search box, or by [adding your own filters](/user/search/queries.md).)
...
1.  Find and click on a relevant search result or search suggestion. (If needed, narrow your search using the suggested search filters below the search box, or by [adding your own filters](/user/search/queries.md).)
...
1.  Scroll through the search results, which show you all commits (and diffs) that match the function name, newest first. (If needed, narrow the diff search by [adding search filters](/user/search/queries.md).)
